-- =====================================================
-- SCHEMA DO PROJETO CHECKIN - SUPABASE
-- =====================================================
...
('Explorador', 'Visitou 10+ lugares diferentes', '🗺️', 'explorer', '{"checkins_count": 10, "unique_venues": 10}'),
('Social', 'Conectou com 50+ pessoas', '👥', 'social', '{"friends_count": 50}'),
('Crítico', 'Fez 20+ avaliações', '⭐', 'critic', '{"reviews_count": 20}'),
('Fotógrafo', 'Compartilhou 30+ fotos', '📷', 'photographer', '{"photos_count": 30}'),
('Grupeiro', 'Participou de 5+ grupos', '👥', 'social', '{"groups_count": 5}'),
('Eventeiro', 'Participou de 10+ eventos', '📅', 'social', '{"events_count": 10}')
ON CONFLICT DO NOTHING;
