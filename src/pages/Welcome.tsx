...
const Welcome = () => {
  ...
  return (
    <div className="mobile-viewport bg-background flex flex-col min-h-screen">
      {/* Top section with logo and branding */}
      <div className="flex-1 flex flex-col justify-center px-8 py-12">
        <div className={`w-full max-w-sm mx-auto transform transition-all duration-1000 ${isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl font-bold gradient-text mb-3 font-ubuntu">CheckIn</h1>
            <p className="text-lg text-gray-600 font-light">Where are we going?</p>
          </div>
        </div>
      </div>
          ...
          <div className="p-8">
            <div className="space-y-6">
              <Button 
                ...
                disabled={isLoading}
                className="w-full h-14 bg-white text-gray-700 border border-gray-200 hover:bg-gray-50 shadow-lg rounded-xl text-base font-medium transition-all duration-200"
              >
                {isLoading ? (
